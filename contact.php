...
require_once ('ads.php');
 ...
 $user_data = check_login($con);
	...
	if (isset($_POST['submit'])){
		...
		$sql_m = "insert into contact_form (name, phone, email, message) values('$name','$phone','$email','$message')";
		mysqli_query($con, $sql_m);
		$msg = "We have received your message, we will get back to within 48 hours.";
	}
?>
<!doctype html>
<html>
...
<?php
	...
	<!-----------------------------------contact form---------------------------------->
	<div class="hero">
			<form method="post" enctype="multipart/form-data" class="cont-form">
				...
				<div class="input-group">
				<input type="text" name="email" placeholder="@gmail.com" id="email" required>
